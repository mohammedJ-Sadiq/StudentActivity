...
{
    [Authorize]
    public class ArabicManageController : Controller
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;

        public ArabicManageController()
        {
        }

        public ArabicManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public ActionResult LinkLogin(string provider, string language)
        {
            ...
            return new EnglishAccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "ArabicManage"), User.Identity.GetUserId());
        }
