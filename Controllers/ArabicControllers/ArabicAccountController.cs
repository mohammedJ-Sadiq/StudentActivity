...
namespace StudentActivity.Controllers
{
    ...
    [Authorize]
    public class ArabicAccountController : Controller
    {
        ...
        public ArabicAccountController()
        {
            _context = new ApplicationDbContext();
        }

        public ArabicAccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string language)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("StudentHome", "ArabicHome");
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model, string language)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction("ResetPasswordConfirmation", "ArabicAccount");
            }
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl, string language)
        {
            ...
            return new ChallengeResult(provider, Url.Action("ExternalLoginCallback", "ArabicAccount", new { ReturnUrl = returnUrl }));
        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl, string language)
        {
            ...
            {
                return RedirectToAction("Index", "ArabicManage");
            }
        ...
        public ActionResult LogOff(string language)
        {
            ...
            Session.Abandon();
            return RedirectToAction("Index", "ArabicHome");
        }
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            return RedirectToAction("Home", "ArabicHome");
        }
