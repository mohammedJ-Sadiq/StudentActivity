...
{
    [Authorize]
    public class EnglishManageController : Controller
    {
        ...
        public EnglishManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public ActionResult LinkLogin(string provider, string language)
        {
            ...
            return new EnglishAccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "EnglishManage"), User.Identity.GetUserId());
        }
