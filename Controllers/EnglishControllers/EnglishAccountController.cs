...
namespace StudentActivity.Controllers
{
    ...
    [Authorize]
    public class EnglishAccountController : Controller
    {
        ...
        public EnglishAccountController()
        {
            _context = new ApplicationDbContext();
        }

        public EnglishAccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string language)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Temp code to add new admin
                    /*var roleStore = new RoleStore<IdentityRole>(new ApplicationDbContext());
                    var roleManager = new RoleManager<IdentityRole>(roleStore);
                    await roleManager.CreateAsync(new IdentityRole("CanManagePrograms"));
                    await UserManager.AddToRoleAsync(user.Id, "CanManagePrograms");
                    ...
                    return RedirectToAction("StudentHome", "EnglishHome");
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction("ResetPasswordConfirmation", "EnglishAccount");
            }
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl)
        {
            ...
            return new ChallengeResult(provider, Url.Action("ExternalLoginCallback", "EnglishAccount", new { ReturnUrl = returnUrl }));
        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            {
                return RedirectToAction("Index", "EnglishManage");
            }
        ...
        public ActionResult LogOff(string language)
        {
            ...
            Session.Abandon();
            return RedirectToAction("Index", "EnglishHome");
        }
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            return RedirectToAction("Home", "EnglishHome");
        }
