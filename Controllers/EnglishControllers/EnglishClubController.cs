...
{
    public class EnglishClubController : Controller
    {
        // GET: Club
        ...
        public EnglishClubController()
        {
            _context = new ApplicationDbContext();
        }

        public EnglishClubController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> SaveClub(Club club, string language)
        {
            ...
            return RedirectToAction("Index", "EnglishClub");
        }
