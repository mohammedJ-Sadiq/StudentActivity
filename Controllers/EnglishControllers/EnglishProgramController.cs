...
{
    public class EnglishProgramController : Controller
    {
        // GET: Program
        ...
        public EnglishProgramController()
        {
    ...
    // ADMIN ACTIONS   
        ...
        public ActionResult SavePrg(Program program, string language)
        {
            ...
            return RedirectToAction("Index", "EnglishProgram");
        }
        ...
        public ActionResult ApproveProgram(int id, string language)
        {
            ...
            DialogResult result = MessageBox.Show(StudentActivity.Resources.Language.Approve_program_confirmation
            ...
            return RedirectToAction("RequestedPrograms", "EnglishProgram");
        }
        ...
        public ActionResult RejectProgram(int id, string language)
        {
            ...
            DialogResult result = MessageBox.Show(StudentActivity.Resources.Language.Reject_program_confirmation
                                                , "Confirmation Message", DeleteMsgButtons);
    ...
    // STUDENT ACTIONS
        ...
        public ActionResult Save(Student_Program studentProgram, string language)
        {
            ...
            catch (DbUpdateException)
            {
                ...
                return RedirectToAction("StuPrograms", "EnglishProgram");
            }
        ...
        public ActionResult DeleteStuPrg(String studentId, int programId, string language)
        {
            ...
            return RedirectToAction("StuPrograms", "EnglishProgram", new { id = StuPrg.StudentId });
        }
